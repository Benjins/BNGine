...
cl /Od /Zi /wd4530 /wd4244 /wd4577 /W3 /Fobuild/ /D_CRT_SECURE_NO_WARNINGS /DBNS_DEBUG /DBNS_EDITOR src/app/win_editor.cpp gen/*.cpp kernel32.lib user32.lib Gdi32.lib Opengl32.lib /FeBNgine_editor.exe